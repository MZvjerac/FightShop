        ...
        <div class="row"> 
          <div class="col-md-12">
            <div class="thumbnail">
              ...
              <div class="caption">
                <h3>Slanje prijedloga borcima</h3>
                ...
                <div class="row1">
                  ...
                  <div class="list-group col-md-4">
                    <input  class="btn btn-danger" type="submit" name="btnKreirajPrijedlog" value="Pregledaj">
                    <br><br>
                    <p>Pregled prijedloga: </p>
                    <br>
                    <textarea cols="35" rows="12" name="kreiranPrijedlog"></textarea>
                  </div>

                  <div class="list-group col-md-4"> 
                    <label>e-mail1</label><br>
                      <input type="email" name="email1" id="email1"><br><br>
                      <label>e-mail2</label><br>
                ...
                <p><a href="#" class="btn btn-danger" role="button">Šalji prijedlog<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></a></p>
                </div>
              </div>
            </div>
