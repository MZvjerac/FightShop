        ...
        <div class="col-sm-6 col-md-4">
          <div class="thumbnail">
            ...
            <div class="caption">
              ...
              <p>Cijena Adidas muskog duksa na slici: <strong>35</strong><span class="glyphicon glyphicon-euro" arra-hidden="true"></span></p>
          ...
          <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
              ...
              <div class="caption">
                ...
                <br /><br />
                <p><a href="#" class="btn btn-danger" role="button">Prikaži više<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a> </p>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
              ...
              <div class="caption">
                ...
                <br /><br />
                <p><a href="#" class="btn btn-danger" role="button">Prikaži više<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></a> </p>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <p>Cijena štitnika za glavu na slici: <strong>85</strong><span class="glyphicon glyphicon-euro" arra-hidden="true"></span></p>
              ...
              <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <p>Cijena štitnika za zube na slici: <strong>65</strong><span class="glyphicon glyphicon-euro" arra-hidden="true"></span></p>
